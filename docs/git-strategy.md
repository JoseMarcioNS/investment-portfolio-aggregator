...
- **PR description auto-generated by Copilot** (saved in docs/pr-descriptions.md)
...
Copilot generates complete PR descriptions automatically and saves them to `docs/pr-descriptions.md`.

Benefits:
- Consistency across all PRs
- Detailed documentation for portfolio/interviews
- Saves time — no need to write descriptions manually

The developer just copies from `docs/pr-descriptions.md` and pastes into GitHub PR.

---

## Private Learning Notes

`docs/learning-notes.md` is added to `.gitignore` — stays local only.

Reason: learning notes are personal study material in Portuguese,
not relevant for public GitHub repository or other developers.
